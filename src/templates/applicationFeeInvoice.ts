...
export function ApplicationFeeInvoiceEmailTemplate(
    name: string,
...
<head>
  ...
  <title>Application Fee Payment EduApply</title>
  <style type="text/css">
      body {
          margin: 0;
...
<body>
  ...
  <center class="wrapper">
      ...
      <table class="main" width="100%">
          ...
          <tr>
              <td>
                  <h1>Thank you for using EduApply</h1>
                  <table class="mb-40" role="presentation" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                          <td>
                              <p class="descriptionText">Dear ${name} You just paid ${currency} ${applicationFee} application fee against application id ${applicationId} for admission in ${courseName} at ${universityName}. You can download your invoice by clicking on the button below</p>
                              .</p>
                          </td>
                      </tr>
                      <tr>
