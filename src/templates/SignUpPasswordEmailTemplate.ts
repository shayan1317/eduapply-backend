...
export function SignUpPasswordEmailTemplate(
    {password, email, name}: {password: string, email: string, name: string}): string {
    return `
    <!DOCTYPE html
...
<body>
    ...
    <center class="wrapper">
        ...
        <table class="main" width="100%">
            ...
            <tr>
                <td>
                    <h1>Signup for EduApply</h1>
                          <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                  <td>
                                      <p class="descriptionText">${name} complete your EduApply signup, use
                          ...
                          <h4 class="mb-40">email: ${email}</h4>
                          <h4 class="mb-40">password: ${password}</h4>
                          <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                  <td class="hr"></td>
                              </tr>
